...
3. track locations and after the first pass, replace all of the 1s with 0s
4. set a flag for each pass. once no papers have been removed, exit the loop
'''
